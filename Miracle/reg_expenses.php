			...
			<div class="col-md-12 col-sm-4 col-xs-12"><br>
				<div class="card">
					<div class="card-header">
						<img class="roundes mx-auto d-block" src="img/logo.png">
						<h2 class="text-center">Expenses</h2>
					</div>
					<div class="card-body">
						<form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
							<label>Description</label>
							<textarea name="expense" class="form-control" cols="5" placeholder="Enter Description" required></textarea><br>
							<label>Amount Spent</label>
							<input type="number" name="amount" class="form-control" placeholder="Enter Amount Spent" required><br>
							...
							<input type="submit" name="reg_expenses" class="btn btn-success btn-block" placeholder="Enter Day"><br>	
						</form>
